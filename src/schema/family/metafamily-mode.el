...
(defconst metafamily2-constructs     '("Attribute" "BaseLanguage" "Construct" "FeatureValue" "File" "MetaLanguage" "Template" "event" "family" "link" "person"))
(defconst metafamily2-attribute-keys '("#" "%" "<" "=" "@" "abbrev" "alias" "aliases" "autokey" "children" "color" "comment" "config" "default" "delim" "dob" "gender" "key" "kind" "name" "parent" "presence" "replacer" "scope" "suffixes" "text" "to" "toplevel" "type" "value" "when" "where" "who"))
