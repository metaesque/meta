...
(defconst metaoopl2-constructs     '("Attribute" "BaseLanguage" "Construct" "FeatureValue" "File" "MetaLanguage" "Template" "accessor" "assoc" "behavior" "block" "category" "class" "field" "lifecycle" "loop" "method" "namespace" "native" "receiver" "remark" "resource" "testx" "var"))
(defconst metaoopl2-attribute-keys '("#" "->" "->" "<" "<<" "<<<" "=" "aliases" "associations" "assocs" "autokey" "children" "comment" "config" "default" "delim" "dispatch" "extensibility" "finalize" "flags" "inheritance" "init" "key" "kind" "lazy" "location" "metaparent" "multiplicity" "mutability" "name" "pack" "params" "parent" "placement" "position" "posts" "preports" "pres" "presence" "provides" "replacer" "returns" "returns" "scope" "select" "span" "status" "suffixes" "super" "target" "test" "testparent" "tests" "toplevel" "type" "value" "visibility"))
(defconst metaoopl2-feature-values '("<concrete" "abstract" "aliaskey" "autodispatch" "closure" "cls" "concrete" "const" "decl" "defn" "extendable" "feature" "final" "finalizer" "general" "immutable" "initializer" "instance" "lib" "meta" "multi" "mutable" "new" "nokey" "nonvirtual" "normal" "noval" "optional" "override" "package" "packed" "post" "postx" "pre" "prex" "primary" "private" "protected" "public" "raw" "required" "ro" "rw" "rwx" "secondary" "showkey" "showval" "specific" "static" "std" "superx" "test" "undef" "unpacked" "user" "userval" "virtual"))
...
(puthash 'metaoopl-assoc-kv (concat "\n\\([ \t]*\\)\\(" (regexp-opt '("cls" "kind" "lib" "location" "meta" "std" "test" "user")) "\[ \t\]\\)*") RE)
(puthash 'metaoopl-assoc-line (concat (gethash 'metaoopl-assoc-kv RE) "\\(assoc\\)[ \t]+\\([^ \t]+\\)") RE)
(puthash 'metaoopl-behavior-kv (concat "\n\\([ \t]*\\)\\(" (regexp-opt '("abstract" "autodispatch" "closure" "concrete" "const" "dispatch" "extendable" "extensibility" "final" "finalizer" "general" "immutable" "inheritance" "initializer" "instance" "kind" "location" "meta" "mutability" "mutable" "new" "nonvirtual" "override" "package" "postx" "presence" "prex" "private" "protected" "public" "span" "specific" "static" "superx" "test" "user" "virtual" "visibility")) "\[ \t\]\\)*") RE)
...
(puthash 'metaoopl-class-kv (concat "\n\\([ \t]*\\)\\(" (regexp-opt '("abstract" "concrete" "location" "meta" "presence" "private" "public" "test" "user" "visibility")) "\[ \t\]\\)*") RE)
(puthash 'metaoopl-class-line (concat (gethash 'metaoopl-class-kv RE) "\\(class\\)[ \t]+\\([^ \t]+\\)") RE)
(puthash 'metaoopl-field-kv (concat "\n\\([ \t]*\\)\\(" (regexp-opt '("inheritance" "instance" "kind" "location" "meta" "new" "optional" "override" "pack" "packed" "raw" "required" "ro" "rw" "rwx" "select" "static" "status" "test" "unpacked" "user")) "\[ \t\]\\)*") RE)
(puthash 'metaoopl-field-line (concat (gethash 'metaoopl-field-kv RE) "\\(field\\)[ \t]+\\([^ \t]+\\)") RE)
(puthash 'metaoopl-lifecycle-kv (concat "\n\\([ \t]*\\)\\(" (regexp-opt '("abstract" "autodispatch" "closure" "concrete" "const" "dispatch" "extendable" "extensibility" "final" "finalizer" "general" "immutable" "initializer" "instance" "kind" "location" "meta" "mutability" "mutable" "nonvirtual" "package" "presence" "private" "protected" "public" "span" "specific" "static" "test" "user" "virtual" "visibility")) "\[ \t\]\\)*") RE)
...
(puthash 'metaoopl-native-kv (concat "\n\\([ \t]*\\)\\(" (regexp-opt '("decl" "defn" "location" "meta" "placement" "position" "post" "pre" "test" "user")) "\[ \t\]\\)*") RE)
...
(puthash 'metaoopl-all-kv (concat "\n\\([ \t]*\\)\\(" (regexp-opt '("<concrete" "abstract" "aliaskey" "autodispatch" "closure" "cls" "concrete" "const" "decl" "defn" "dispatch" "extendable" "extensibility" "feature" "final" "finalizer" "general" "immutable" "inheritance" "initializer" "instance" "key" "kind" "lib" "location" "meta" "multi" "multiplicity" "mutability" "mutable" "new" "nokey" "nonvirtual" "normal" "noval" "optional" "override" "pack" "package" "packed" "placement" "position" "post" "postx" "pre" "presence" "prex" "primary" "private" "protected" "public" "raw" "required" "ro" "rw" "rwx" "secondary" "select" "showkey" "showval" "span" "specific" "static" "status" "std" "superx" "test" "undef" "unpacked" "user" "userval" "value" "virtual" "visibility")) "\[ \t\]\\)*") RE)
