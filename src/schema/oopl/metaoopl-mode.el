...
(puthash 'metaoopl-field-kv (concat "\n\\([ \t]*\\)\\(" (regexp-opt '("access" "inheritance" "instance" "kind" "location" "meta" "new" "optional" "override" "owned" "ownership" "raw" "required" "ro" "rw" "rwx" "static" "status" "test" "tmpprivate" "tmppublic" "unowned" "user" "usertest" "visibility")) "\[ \t\]\\)*") RE)
