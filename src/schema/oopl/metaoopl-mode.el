...
(defconst metaoopl2-attribute-keys '("#" "->" "->" "<" "<<" "<<<" "=" "@" "alias" "aliases" "associations" "assocs" "autogen" "autokey" "children" "clinit" "clsetup" "clteardown" "color" "comment" "compilation" "config" "default" "delim" "dispatch" "extensibility" "finalize" "flags" "inheritance" "init" "interface" "key" "kind" "lazy" "location" "metafinalize" "metainit" "metaparent" "multiplicity" "mutability" "name" "optimization" "pack" "params" "parent" "path" "placement" "position" "posts" "preports" "pres" "presence" "provides" "replacer" "returns" "returns" "scope" "select" "setup" "span" "status" "suffixes" "super" "target" "teardown" "test" "testparent" "testpreports" "tests" "toplevel" "type" "value" "visibility"))
(defconst metaoopl2-feature-values '("<concrete" "abstract" "aliaskey" "autodispatch" "closure" "cls" "concrete" "const" "decl" "defn" "explicit" "extendable" "feature" "final" "finalizer" "general" "immutable" "implicit" "initializer" "inline" "instance" "lib" "meta" "multi" "mutable" "named" "new" "nokey" "nometa" "nometanotest" "nonvirtual" "normal" "notest" "noval" "optional" "outline" "override" "package" "packed" "post" "postx" "pre" "prex" "primary" "private" "protected" "public" "raw" "required" "ro" "rw" "rwx" "scoped" "secondary" "showkey" "showval" "specific" "static" "std" "superx" "test" "tmpprivate" "tmppublic" "undef" "unpacked" "user" "usertest" "userval" "virtual"))
...
(puthash 'metaoopl2-field-kv (concat "\n\\([ \t]*\\)\\(" (regexp-opt '("inheritance" "instance" "kind" "location" "meta" "new" "optional" "override" "pack" "packed" "raw" "required" "ro" "rw" "rwx" "select" "static" "status" "test" "tmpprivate" "tmppublic" "unpacked" "user" "usertest" "visibility")) "\[ \t\]\\)*") RE)
...
(puthash 'metaoopl2-all-kv (concat "\n\\([ \t]*\\)\\(" (regexp-opt '("<concrete" "abstract" "aliaskey" "autodispatch" "autogen" "closure" "cls" "compilation" "concrete" "const" "decl" "defn" "dispatch" "explicit" "extendable" "extensibility" "feature" "final" "finalizer" "general" "immutable" "implicit" "inheritance" "initializer" "inline" "instance" "key" "kind" "lib" "location" "meta" "multi" "multiplicity" "mutability" "mutable" "named" "new" "nokey" "nometa" "nometanotest" "nonvirtual" "normal" "notest" "noval" "optimization" "optional" "outline" "override" "pack" "package" "packed" "placement" "position" "post" "postx" "pre" "presence" "prex" "primary" "private" "protected" "public" "raw" "required" "ro" "rw" "rwx" "scoped" "secondary" "select" "showkey" "showval" "span" "specific" "static" "status" "std" "superx" "test" "tmpprivate" "tmppublic" "undef" "unpacked" "user" "usertest" "userval" "value" "virtual" "visibility")) "\[ \t\]\\)*") RE)
