...
goog.require('demo.cards2_test.PileTest__Meta');
...
/**
 * demo.cards2_test.PileTest.PileTest
 * @param {!string} meta__name
 * @public
 * @constructor
 * @extends {meta.testing.TestCase}
 */
demo.cards2_test.PileTest = function(meta__name) {
  demo.cards2_test.PileTest.base(this, 'constructor', meta__name);
  // User-provided code follows.
};
goog.inherits(demo.cards2_test.PileTest, meta.testing.TestCase);

var testCase = new demo.cards2_test.PileTest('demo.cards2_test.PileTest');
// TODO(wmh): Look into
