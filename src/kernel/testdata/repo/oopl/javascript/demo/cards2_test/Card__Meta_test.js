...
goog.setTestOnly('demo.cards2_test.Card__MetaTest');
...
/**
 * demo.cards2_test.Card__MetaTest.Card__MetaTest
 * @param {!string} meta__name
 * @public
 * @constructor
 * @extends {meta.testing.TestCase}
 */
demo.cards2_test.Card__MetaTest = function(meta__name) {
  demo.cards2_test.Card__MetaTest.base(this, 'constructor', meta__name);
  // User-provided code follows.
};
goog.inherits(demo.cards2_test.Card__MetaTest, meta.testing.TestCase);

var testCase = new demo.cards2_test.Card__MetaTest('demo.cards2_test.Card__MetaTest');
// TODO(wmh): Look into
