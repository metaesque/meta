...
class FakeFcntlMeta(metax.root.ObjectMetaRoot):
  """Auto-generated meta class for FakeFcntl."""
...
class StubHolderMeta(metax.root.ObjectMetaRoot):
  """Auto-generated meta class for StubHolder."""
...
class TestCaseMeta(metax.root.ObjectMetaRoot):
  """Auto-generated meta class for TestCase."""
...
class TestCase(unittest.TestCase):
  ...
  In Meta<javascript>, the above control flow is changed as follows:
   ...
   - The <C>Test class inherits (directly or indirectly) from
     TestCase (which inherits from goog.testing.TestCase),
   ...
   - In <C>_test.js file, after the definition of <C>Test, the following
     code exists:
       ...
       testCase.run();
   - The 'run' method (TestCase.run) does the following:
  ...
  def __init__(self, method_name):
    ...
    count = TestCase.InstanceCount() + 1
    TestCase.InstanceCountIs(count)
  ...
  def status(self):
    ...
    # in TestCase ... this would override the field
